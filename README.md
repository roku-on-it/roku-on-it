...
### My skills and tools
[![My Skills](https://skillicons.dev/icons?i=rust,actix,aws,ts,js,rxjs,nest,deno,nginx,rabbitmq,redis,kafka,cs,dotnet,angular,scss,git,docker,postgres,mysql,bash,linux,prisma,go)](https://skillicons.dev)
